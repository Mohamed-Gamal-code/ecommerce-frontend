...
export const deleteProductImage = async (productId, imageId, token) => {
  try {
    ...
    const res = await fetch(`${API_URL}/product/${productId}/${imageId}`, {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
export const updateProductReview = async (
  ...
  try {
    ...
    const res = await fetch(`${API_URL}/product/${productId}/${reviewId}`, {
      method: "PUT",
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-Type": "application/json",
...
export const getDashboardStats = async (token) => {
  try {
    ...
    const res = await fetch(`${API_URL}/product/stats`, {
      method: "GET",
      headers: {
        Authorization: `Bearer ${token}`,
      },
